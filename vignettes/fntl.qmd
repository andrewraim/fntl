...
The function `optif9` is in the experimental R API and therefore may be removed from future versions of R. If this occurs, the code in the present section will accordingly be removed from `fntl`.
:::
