...
::: {.callout-note title="TBD"}
Should $vec{a}$ be of type $\mathbb{U}$ or just a vector of scalars? Until now, we were only thinking about numerical matrices.
...
$$
<!-- -->
Now suppose $f(x,y) : \mathbb{X} \times \mathbb{Y} \rightarrow \mathbb{U}$
