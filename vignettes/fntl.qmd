...
::: {.callout-warning}
The function `optif9` is in the experimental R API and therefore may be removed in future versions of R. If this occurs, it will also be removed from `fntl`.
:::
